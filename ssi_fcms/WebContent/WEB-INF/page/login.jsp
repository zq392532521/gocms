...
<script src="../../jqueryTools/jquery-1.5.1.min.js"></script>
<script src="../../jqueryTools/cookie.js"></script>
...
<body >
<form id="fm1" class="fm-v clearfix" action="login_dologin.do" method="post" onsubmit="return submitForm()">
<div id="Logo">
