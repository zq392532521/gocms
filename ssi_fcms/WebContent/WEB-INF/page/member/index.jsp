...
function changeDisplayMode(){
	if(document.getElementById("bottomframes").cols=="192,7,*"){
		...
		document.getElementById("separator").contentWindow.document.getElementById('ImgArrow').src="../../../../img/member/separator2.gif"
	}else{
		document.getElementById("bottomframes").cols="192,7,*"
		document.getElementById("separator").contentWindow.document.getElementById('ImgArrow').src="../../../../img/member/separator1.gif"
	}
}
</script>
