...
<html>
	...
	<script type="text/javascript" src="<%=checkParentBasePath%>js/ckfinder/ckfinder.js"></script>
			<script type="text/javascript" src="<%=checkParentBasePath%>jqueryTools/ckfinderUtil.jsp"></script>
	<link type="text/css" rel="stylesheet" href="../../../jqueryTools/weebox0.4/weebox.css" />
<script type="text/javascript" src="../../../js/page/admin/func.js">
</script>
	</head>
	<body >
      ...
      <div id="one"><fs:operButton buttonName="添加一级菜单" />
		  ...
		  <input type="hidden" name="parid" value="" id="parid">
     		 ...
     		 <tr>
          		...
          		<td colspan="3" height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">
          			<select id="setMenuIcon" onchange="setMenuicon();">
          				<option value="1" selected="selected" >使用默认图标:</option>
          				<option value="2">选择本地图标</option>
          				<option value="3">选择服务器上图标</option>
          			</select>
