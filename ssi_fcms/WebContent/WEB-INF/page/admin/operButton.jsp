...
<%@page import="cn.freeteam.service.impl.OperbuttonServiceImpl"%>
...
<html>
	...
	<script src="../../../js/page/admin/operButton.js" type="text/javascript"></script>
	</head>
	<body ><center>
<div id="man_zone" >
  ...
  <tr>
  <td colspan="10">
  <span id="state" style="display:none"><img src="../../../jqueryTools/images/ajax-loader.gif">正在操作中...</span>
