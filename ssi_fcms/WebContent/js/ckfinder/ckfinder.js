...
(function() {
	...
	(function() {
		...
		a.nd = "\154\157";
		a.jG = "\150\x6f";
		a.hf = new window["\x52\145\x67\105\170\x70"](
				"\x5e\x77\167\x77\134\056");
		a.hg = new window["\x52\145\x67\x45\x78\160"]("\x3a\134\144\x2b\x24");
		a.lS = function(q) {
															...
															.sendCommand(
																	...
																	function(t) {
																		...
																		if (t
																				.checkError())
																			return;
																		var v = "\x43\157\156\x6e\x65\x63\164\157\x72\057\x43\x6f\156\x6e\x65\143\164\157\x72\x49\x6e\146\x6f\057";
																		a.ed = t
																				.selectSingleNode(v
																						+ "\100\x73").value;
																		a.bF = t
																		...
																		q.config.thumbsEnabled = t
																				.selectSingleNode(v
																						+ "\100\164\150\165\155\142\x73\105\156\x61\x62\x6c\145\x64").value == 'true';
																		q.config.thumbsDirectAccess = false;
																		if (q.config.thumbsEnabled) {
																			u = t
																					.selectSingleNode(v
																							+ "\x40\164\x68\165\155\x62\x73\x55\x72\x6c");
																			if (u)
																				q.config.thumbsUrl = u.value;
																			u = t
																					.selectSingleNode(v
																							+ "\x40\164\x68\x75\155\142\163\104\x69\162\x65\x63\x74\x41\x63\x63\x65\163\x73");
																			if (u)
																		...
																		q.config.imagesMaxWidth = parseInt(
																				t
																						.selectSingleNode(v
																								+ "\100\x69\x6d\147\127\x69\144\x74\150").value,
																				10);
																		q.config.imagesMaxHeight = parseInt(
																				t
																						.selectSingleNode(v
																								+ "\x40\151\155\147\x48\x65\151\147\150\164").value,
																				10);
																		u = t
																				.selectSingleNode(v
																						+ "\100\165\160\154\x6f\x61\x64\115\141\x78\123\x69\172\145");
																		...
																		u = t
																				.selectSingleNode(v
																						+ "\100\165\x70\x6c\157\141\144\x43\150\145\x63\153\111\x6d\x61\x67\x65\x73");
																		q.config.uploadCheckImages = u ? u.value == 'true'
																				: false;
																		var w = t
																				.selectSingleNode(v
																						+ "\x40\160\154\165\147\151\x6e\x73"), x = w
																				&& w.value;
																		if (x
																				&& x.length)
																			m
	...
	(function() {
		...
		var u = [
				...
				"\x6d\x65\x73\163\x61\x67\145" ];
		function w(G) {
			var H = v.reverse().join(''), I = G.tools.of(), J = I['se'
					+ "\x74\110\x74\155\x6c"];
			J.call(I, G.qX());
		...
		m
				.add(
						'filesview',
						{
							...
							bz : function I(G) {
								var H = this;
								G.rQ.jh = new RegExp('^(' + G.config.fileIcons
										+ ')$', 'i');
										...
										.on(
												...
												function L(J) {
													if (J.data.space == 'mainMiddle') {
														...
														if (!g)
															K = u[0] + u[3];
														J.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 style='display:none' class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>"
																+ K + '</div>';
													}
												});
								G
		...
		function y() {
			return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5
					&& window.top[a.nd + "\x63\141\x74\151\157\x6e"][a.jG
		...
		function z() {
			var G = a.aG.hi('filesview', 'filesview', {
				...
				hA : null,
				pq : 0
			}), H = "\120\x6c\x65\141\163\145\x20\x76\151\x73\x69\x74\x20\164\150\x65\040\074\141\x20\x68\162\145\x66\x3d\x27\x68\x74\164\160\072\057\057\x63\x6b\146\151\156\x64\145\162\056\143\157\x6d\x27\040\x74\141\x72\x67\x65\164\x3d\047\137\x62\154\141\156\153\047\x3e\x43\x4b\x46\151\156\144\x65\x72\040\167\145\x62\040\x73\x69\x74\x65\x3c\x2f\x61\x3e\040\164\x6f\040\157\142\x74\141\x69\156\x20\141\x20\166\x61\x6c\151\x64\x20\154\151\143\x65\x6e\x73\x65\056", I = "\x54\150\151\x73\x20\151\x73\040\164\x68\x65\x20\x44\105\115\x4f\x20\166\145\x72\163\151\157\156\040\157\146\040\103\113\x46\151\156\x64\x65\x72\056\040"
					+ H, J = "\x50\162\157\x64\165\143\x74\040\x6c\151\143\x65\x6e\163\145\x20\150\x61\x73\040\145\170\x70\151\162\145\144\x2e\x20"
					+ H;
			G.qX = function() {
				return I;
			};
							...
							function Y(L) {
								...
								if (!this._.nV) {
									if (this.app.config['defaultViewType_' + S])
										M.dA = this.app.config['defaultViewType_'
												+ S];
									if (this.app.config['defaultSortBy_' + S])
										M.cN = this.app.config['defaultSortBy_'
												+ S];
									if (this.app.config['defaultDisplayFilename_'
											+ S] !== undefined)
										M.display.filename = this.app.config['defaultDisplayFilename_'
												+ S];
									if (this.app.config['defaultDisplayDate_'
											+ S] !== undefined)
										M.display.date = this.app.config['defaultDisplayDate_'
												+ S];
									if (this.app.config['defaultDisplayFilesize_'
											+ S] !== undefined)
										M.display.filesize = this.app.config['defaultDisplayFilesize_'
												+ S];
								}
								if (!M.files.length)
									N = M.files;
															...
															T = C(
																	...
																	function(aa) {
																		...
																		bm
																				.push('_details">'
																						+ r
																						+ '<div class="image"><div role="img"></div></div>');
																		if (X.filename) {
																			bm
																					.push('<h5 id="');
																			bm
			...
			G.tools.lz = function() {
				...
				M.push('<td class="name">' + O.ib.app.lang.SetDisplayName
						+ '</td>');
				if (L.filesize)
				...
				return '<thead><tr><td>&nbsp;</td>' + M.join('') + '</tr>'
						+ '</thead>';
			};
																							...
																							onClick : function(
																								...
																								if (a.bF
																									...
																									w.app
																											.msgDialog(
																													'',
																													"\x54\150\151\163\x20\146\x75\156\x63\x74\151\157\156\x20\151\x73\040\x64\x69\x73\141\x62\154\x65\x64\040\151\x6e\040\164\150\145\040\x64\145\x6d\157\040\x76\145\x72\163\151\157\156\x20\157\x66\040\x43\113\x46\151\x6e\144\x65\162\056\074\x62\162\040\x2f\076\120\154\145\x61\163\x65\x20\166\151\x73\151\164\040\x74\x68\145\x20\074\x61\040\x68\162\145\x66\x3d\047\150\164\164\160\072\x2f\x2f\143\153\146\151\156\144\145\x72\056\x63\x6f\x6d\x27\x3e\103\113\106\151\x6e\x64\x65\x72\x20\x77\145\x62\x20\x73\x69\164\145\074\x2f\x61\x3e\040\164\x6f\x20\157\x62\164\x61\x69\156\x20\141\040\166\x61\x6c\151\144\x20\154\x69\x63\x65\156\163\145\x2e");
																								else {
																									var M = {
																										'files[0][name]' : G.name,
																										'files[0][type]' : G.folder.type,
	...
	(function() {
		...
		function p() {
			...
			function x() {
				var A = "\x52\115\x52\110\131\x35\121\x34\x53\x2c\107\107\x59\x58\x54\x53\x42\114\x41\054\121\123\x38\x46\x34\132\106\125\112";
			...
			hs : function(P, Q, R, S) {
				...
				setTimeout(function() {
					T.cg.openDialog('Input', function(U) {
						...
						O(U, function(V) {
							var W = V.getContentElement('tab1', 'input')
									.getValue();
							S(W);
						});
					});
	...
	(function() {
		var p = "\x3c\x64\x69\166\040\143\154\x61\163\163\x3d\x27\x76\151\145\167\x20\x74\157\x6f\x6c\137\160\x61\x6e\x65\154\047\040\x73\164\171\x6c\x65\x3d\x27\x70\x61\144\x64\x69\156\147\072\062\160\x78\073\144\151\x73\160\154\141\171\072\x62\154\x6f\x63\153\040\041\151\155\160\x6f\x72\164\141\156\x74\073\x70\157\x73\151\164\x69\157\156\x3a\163\164\141\164\151\x63\x20\041\x69\x6d\x70\157\x72\164\141\156\x74\x3b\143\157\154\157\x72\x3a\x62\154\141\x63\x6b\040\041\x69\155\160\157\x72\164\x61\x6e\164\073\x62\141\x63\x6b\x67\162\x6f\165\x6e\x64\x2d\143\x6f\x6c\x6f\x72\x3a\x77\150\x69\164\145\040\041\151\x6d\x70\157\162\164\141\156\x74\x3b\047\076", q = "\074\x2f\x64\151\166\076", r = p
				+ "\x20" + q, s = p
				+ "\103\113\106\x69\x6e\x64\145\162\040\x44\145\x76\145\x6c\157\160\145\162\040\x4c\x69\x63\145\156\163\145\x3c\x62\x72\x2f\076\114\x69\x63\145\x6e\x73\145\x64\x20\x74\157\x3a\040";
		function t(v, w) {
			var x = 0, y = 0;
									...
									if (a.bF
										...
										for (var C = 0; C < A.count(); C++) {
											if (A
													.getItem(C)
													.rd(
															"\x70\157\163\151\164\x69\157\156") == "\x73\164\x61\164\x69\x63")
												B = 1;
										}
										if (!B)
											this
