...
public class MemberAction extends BaseAction{
	...
	public String profile(){
		try {
			if (getLoginMember()!=null) {
				...
				log(getLoginMemberName(), "更新个人资料", getHttpRequest());
			}
			return showMessage("更新个人资料成功", "profile.jsp", 3);
		} catch (Exception e) {
			log(getLoginMemberName(), "更新个人资料失败:"+e.toString(), getHttpRequest());
	...
	public String pwd(){
		...
		log(member.getLoginname(), showMessage, getHttpRequest());
