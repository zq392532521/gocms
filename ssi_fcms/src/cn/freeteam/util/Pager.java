...
public class Pager {
	...
	public void setOutStr(String action) {
		...
		try {
			...
			sb.append("       <td width=\"30\" height=\"40\" align=\"center\" valign=\"middle\"><a href=\"javascript:"+(totalPage>1?"if(isNaN(pageForm.pageNum.value)==false&&pageForm.pageNum.value!="+currPage+"&&pageForm.pageNum.value>=1&&pageForm.pageNum.value<="+totalPage+"){pageForm.currPage.value=pageForm.pageNum.value;pageForm.submit();}":"void(0)")+"\"><img src=\""+basePath+"/img/admin/cms/go.gif\" width=\"26\" height=\"22\" border=\"0\"></a></td>");
			sb.append("		</tr>");
			sb.append("	  </table></td>");
			sb.append("	</tr>");
			sb.append("</table>");
	...
	public void setOutStrNoTable(String action) {
		...
		try {
			...
			sb.append("<a href=\"javascript:"+(totalPage>1?"if(isNaN(pageForm.pageNum.value)==false&&pageForm.pageNum.value!="+currPage+"&&pageForm.pageNum.value>=1&&pageForm.pageNum.value<="+totalPage+"){pageForm.currPage.value=pageForm.pageNum.value;pageForm.submit();}":"void(0)")+"\"><img src=\""+basePath+"/img/admin/cms/go.gif\" width=\"26\" height=\"22\" border=\"0\"></a>");
			sb.append("</form>");
